...
LIBNAME FL_DEC 'H:\navy_fmo\Audit Readiness\SOURCE DATA\STARS-FL\FY13\DEC\SAS Datasets';
LIBNAME FL_JAN 'H:\navy_fmo\Audit Readiness\SOURCE DATA\STARS-FL\FY13\JAN\SAS Datasets';
LIBNAME FL_FEB 'H:\navy_fmo\Audit Readiness\SOURCE DATA\STARS-FL\FY13\FEB\SAS Datasets';
LIBNAME FL_MAR 'H:\navy_fmo\Audit Readiness\SOURCE DATA\STARS-FL\FY13\MAR\SAS Datasets';
...
*%CONTROL_TOTALS(FL_JAN.FL_FY13_JAN,AMOUNT_USSGL_FINAL);
/*UTILIZE THE STARS-FL JAN&FEB FY13 POPULATION AND LIMIT TO TRANSACTIONS TO CERTAIN GL4'S BASED ON CFMS EXECUTION CODES*/

DATA FL_RECON; 
	SET FL_JAN.FL_FY13_JAN FL_FEB.FL_FY13_FEB;
...
DATA FL_ONLY_4MNTHS;
	SET FL_JAN.FL_FY13_JAN FL_FEB.FL_FY13_FEB FL_DEC.FL_FY13_DEC FL_MAR.fl_fy13_mar;
	where APN_BEG_FIS_YR IN ('13') and
	SUBSTR(GL4,1,1)='4' and 
	GA='17';
RUN;
...
DATA FL_INTERFACE;
	...
	where datamonth not in ('DECFY2013')and
	...
	ELSE IF USR_ID	 = 'SU0' AND DATA_SRC_CODE = '>' THEN FEEDER_SYSTEM = 'INTERFACE TRANSACTIONS - STATION USE (ASHORE ONLY)'; /* CHANGED INTERFACE NAME FROM SNAP2...PER KATIE'S EMAIL ON 01/08/2013 */
...
/********************************************************************************************/
/* EXTRACT STARS-FL Q2 FY2013 EUD FEEDER SYSTEM TRANSACTIONS & PERFORM SUMMARIES. 			*/
/********************************************************************************************/
...
DATA FL_RECON_JAN2;
	SET FL_JAN.FL_FY13_JAN;
	where APN_BEG_FIS_YR IN ('13') and
	SUBSTR(GL4,1,1)='4';
RUN;

DATA FL_RECON_FEB2;
	SET FL_FEB.FL_FY13_FEB;
	where APN_BEG_FIS_YR IN ('13') and
	SUBSTR(GL4,1,1)='4';
RUN;
...
proc means data=FL_JAN.FL_FY13_JAN;
var GL4;
run;
FL_JAN.FL_FY13_JAN FL_FEB.FL_FY13_FEB
FL_RECON;


PROC IMPORT OUT=SPS_UNMATCH 
DATAFILE = "H:\navy_fmo\Audit Readiness\SEGMENTS\CVP\Feeder System Reconciliation\SPS\COMFISC\Outputs\Output_20130515_modified.xls"
